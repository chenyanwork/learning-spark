...
object GroupedTopN {
  def main(args: Array[String]) {
    ...
    conf.setAppName("GroupedTopN") //设置应用程序的名称，在程序运行的监控界面可以看到名称
    ...
    val lines = sc.textFile("D://Big_Data_Software//spark-1.6.0-bin-hadoop2.6//testData//topNGroup.txt") //读取本地文件并设置为一个Partition
