...
object MovieLensALSLocal {
  ...
  def main(args: Array[String]) {
    ...
    //装载用户评分，该评分由评分器生成
    val myRatings = loadRatings("D:\\Big_Data_Software\\spark-1.6.1-bin-hadoop2.6\\data\\mllib\\als\\personalRatings.txt")
    val myRatingsRDD = sc.parallelize(myRatings, 4)


    //样本数据目录
    val movieLensHomeDir = "/D:\\Big_Data_Software\\spark-1.6.1-bin-hadoop2.6\\data\\mllib\\als\\movielens\\large"
